...
export const CEREBRUM_PROVIDERS: readonly CerebrumProviderDefinition[] = [
  ...
  },
  {
    ...
    models: [
      { value: DEFAULT_OPENAI_CODEX_MODEL, label: 'GPT-5.5', hint: 'default, frontier intelligence for Codex' },
      { value: 'gpt-5.4', label: 'GPT-5.4', hint: 'flagship for professional work' },
      { value: 'gpt-5.4-mini', label: 'GPT-5.4 Mini', hint: 'fast, efficient mini for responsive coding tasks, new' },
      { value: 'gpt-5.3-codex', label: 'GPT-5.3 Codex', hint: 'industry-leading coding specialist, new' },
      { value: 'gpt-5.3-codex-spark', label: 'GPT-5.3 Codex Spark', hint: 'Pro-only research preview, real-time coding (text-only), new' },
    ],
